...
@docker_routes.route("/api/services/<name>/stats")
@cross_origin()
...
@docker_routes.route("/api/services/add", methods=["POST"])
@cross_origin()
def add_service():
    data = request.json
...
@docker_routes.route("/api/services/<name>/start", methods=["POST"])
@cross_origin()
...
@docker_routes.route("/api/services/<name>/exit", methods=["POST"])
@cross_origin()
...
@docker_routes.route("/api/services")
@cross_origin()
def get_services():
